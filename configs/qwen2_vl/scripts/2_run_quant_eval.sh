#!/bin/bash
set -e
CONFIG_PATH="configs/qwen2_vl/Eval/my_2b_seedbench_eval.yaml"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/seedbench/qwen2vl/qwen2vl_2b_w2g32_scale_reweight_true_svd_1.0_mixed_0.3.log"
GPU_ID=6
