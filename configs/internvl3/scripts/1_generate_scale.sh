...
# Configuration
CONFIG_PATH="configs/internvl3/MBQ_search/my_1b_weight_only_svd.yaml"  # Change this to your model path
LOG_DIR="./logs"  # Directory to save logs
LOG_FILE="${LOG_DIR}/internvl3/internvl3_1b_w2g32_scale_reweight_true_svd_1.0_mixed_0.3.log"  # Log file name
