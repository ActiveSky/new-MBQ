...
# Configuration
CONFIG_PATH="configs/qwen2_vl/MBQ_search/my_2b_weight_only.yaml"  # Change this to your model path
LOG_DIR="./logs"  # Directory to save logs
LOG_FILE="${LOG_DIR}/qwen2vl/qwen2_vl_2b_w2g32_scale_reweight_true_svd_1.0_mixed_0.3.log"  # Log file name
